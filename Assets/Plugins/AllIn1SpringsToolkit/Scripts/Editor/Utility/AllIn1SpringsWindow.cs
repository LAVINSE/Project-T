...
namespace AllIn1SpringsToolkit
{
    public class AllIn1SpringsWindow : EditorWindow
    {
        ...
        private void EnableOrDisableFeature()
        {
			...
			currentDefines = PlayerSettings.GetScriptingDefineSymbols(namedBuildTarget);
		...
		private void FixSpringsSizes()
		{
			...
			SpringComponent[] springsComponents = FindObjectsByType<SpringComponent>(FindObjectsInactive.Include, FindObjectsSortMode.None);
			#else
