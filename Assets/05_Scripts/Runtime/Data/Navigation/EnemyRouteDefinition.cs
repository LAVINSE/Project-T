...
namespace ProjectT.Data
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "EnemyRoute", menuName = "Project T/디펜스/적 고정 경로")]
    [UnityEngine.Scripting.APIUpdating.MovedFrom(true, "ProjectT.Defense.Navigation", "ProjectT.Defense.Runtime", "EnemyRouteDefinition")]
    public sealed class EnemyRouteDefinition : SWScriptableObject
    {
        #region 필드
        [SWGroup("적 고정 경로")]
